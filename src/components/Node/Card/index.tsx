...
const NodeCardBase: React.FC<NodeCardType> = ({
  ...
  const [fieldType, setfieldType] = React.useState(
    isField ? node.metadata[APP_ID].fieldType : ""
  );
  ...
  React.useEffect(() => {
    ...
    setfieldType(isField ? node.metadata[APP_ID].fieldType : "");
  }, [node, isField, setfieldType, setname]);
  ...
  }, [fetchChildrens, setloading, node, setchilds]);
