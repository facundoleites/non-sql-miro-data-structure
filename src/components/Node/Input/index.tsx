...
type onBlurFieldTypeType = (event: React.FocusEvent<HTMLSelectElement>) => void;

type onBlurNameType = (event: React.FocusEvent<HTMLInputElement>) => void;

type onChangeFieldTypeType = (
  event: React.ChangeEvent<HTMLSelectElement>
) => void;

type onChangeNameType = (event: React.ChangeEvent<HTMLInputElement>) => void;
